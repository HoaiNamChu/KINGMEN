            ...
            <ul class="aside-cart-product-list">
                ...
                <li class="product-list-item">
                    ...
                    <a href="single-product.html">
                        <img src="{{$cart->image}}" width="90"
                             height="110" alt="Image-HasTech">
                        <span class="product-title">{{$cart->name}}</span>
                    </a>
                    <span class="product-price">1 × {{number_format($cart->price)}}$</span>
                </li>
                @endforeach

            </ul>
            <p class="cart-total"><span>Subtotal:</span><span class="amount">£89.99</span></p>
            <a class="btn-theme" data-margin-bottom="10" href="{{route('listcart')}}">View cart</a>
