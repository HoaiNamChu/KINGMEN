            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-3">
                    ...
                    <div class="widget-item widget-services-item">
                        ...
                        <h4 class="widget-collapsed-title collapsed" data-bs-toggle="collapse"
                            data-bs-target="#widgetId-1">Services</h4>
                ...
                <div class="col-md-6 col-lg-3">
                    ...
                    <div class="widget-item widget-account-item">
                        ...
                        <h4 class="widget-collapsed-title collapsed" data-bs-toggle="collapse"
                            data-bs-target="#widgetId-2">My Account</h4>
                ...
                <div class="col-md-6 col-lg-3">
                    ...
                    <div class="widget-item">
                        ...
                        <h4 class="widget-collapsed-title collapsed" data-bs-toggle="collapse"
                            data-bs-target="#widgetId-3">Contact Info</h4>
            ...
            <div class="row">
                <div class="col-md-7 col-lg-6">
                    <p class="copyright">© 2021 Shome. Made with <i class="fa fa-heart"></i> by <a target="_blank"
                                                                                                   href="https://themeforest.net/user/codecarnival/portfolio">Codecarnival.</a>
                    </p>
                </div>
                <div class="col-md-5 col-lg-6">
                    <div class="payment">
                        <a href="account-login.html"><img
                                src="{{ asset('theme/client/assets/img/photos/payment-card.webp') }}" width="192"
