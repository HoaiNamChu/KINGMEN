...
@section('content')
            ...
            <div class="about-item position-relative">
                <div class="row align-items-center">
                  ...
                  <span class="scene-layer" data-depth=".2">
                    <img src="{{ asset('theme/client/assets/img/about/1.webp') }}" width="570" height="368" alt="Image-HasTech">
                  </span>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="about-content">
                            ...
                            <p class="desc">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmol
                                tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minivel quis nostrud
                                exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute
                                irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla
                                pariatur. Excepteur sint occaecat cupidata non proident, sunt in culpa qui
                                officia.</p>
            ...
            <div class="row">
                <div class="col-sm-6 col-lg-3">
                    ...
                    <div class="team-item">
                        <div class="inner-content">
                            <div class="thumb">
                                <a href="about-us.html"><img src="{{ asset('theme/client/assets/img/team/1.webp') }}" width="270" height="270"
                                                             alt="Image-HasTech"></a>
                ...
                <div class="col-sm-6 col-lg-3">
                    ...
                    <div class="team-item">
                        <div class="inner-content">
                            <div class="thumb">
                                <a href="about-us.html"><img src="{{ asset('theme/client/assets/img/team/2.webp') }}" width="270" height="270"
                                                             alt="Image-HasTech"></a>
                                <div class="member-icons">
                                    <a href="https://www.facebook.com/" target="_blank" rel="noopener"><i
                                            class="fa fa-facebook"></i></a>
                ...
                <div class="col-sm-6 col-lg-3">
                    ...
                    <div class="team-item">
                        <div class="inner-content">
                            <div class="thumb">
                                <a href="about-us.html"><img src="{{ asset('theme/client/assets/img/team/3.webp') }}" width="270" height="270"
                                                             alt="Image-HasTech"></a>
                                <div class="member-icons">
                                    <a href="https://www.facebook.com/" target="_blank" rel="noopener"><i
                                            class="fa fa-facebook"></i></a>
                ...
                <div class="col-sm-6 col-lg-3">
                    ...
                    <div class="team-item">
                        <div class="inner-content">
                            <div class="thumb">
                                <a href="about-us.html"><img src="{{ asset('theme/client/assets/img/team/4.webp') }}" width="270" height="270"
                                                             alt="Image-HasTech"></a>
                                <div class="member-icons">
                                    <a href="https://www.facebook.com/" target="_blank" rel="noopener"><i
                                            class="fa fa-facebook"></i></a>
    ...
    <section class="testimonial-area bg-color-f2 position-relative z-index-1">
                        ...
                        <div class="swiper-wrapper">
                                ...
                                <div class="testimonial-item">
                                    <div class="testi-inner-content">
                                        <div class="testi-thumb">
                                            <img src="{{ asset('theme/client/assets/img/testimonial/1.webp') }}" width="90" height="90"
                                                 alt="Image-HasTech">
                                        </div>
                                        <div class="testi-content">
                                            <p>Lorem ipsum dolor sit amel adipiscing elit, sed do eiusll tempor
                                                incididunt ut laborj et dolore magna.</p>
                                            <div class="testi-author">
                                                <div class="testi-info">
                                                        <span class="name"><a
                                                                href="about-us.html">Jaren Hammer</a></span>
                                                </div>
                                            </div>
                                            <div class="testi-quote"><img src="{{ asset('theme/client/assets/img/icons/quote1.webp') }}"
                                                                          width="62" height="44"
                            ...
                            <div class="swiper-slide">
                                ...
                                <div class="testimonial-item">
                                    <div class="testi-inner-content">
                                        <div class="testi-thumb">
                                            <img src="{{ asset('theme/client/assets/img/testimonial/2.webp') }}" width="90" height="90"
                                                 alt="Image-HasTech">
                                        </div>
                                        <div class="testi-content">
                                            <p>Lorem ipsum dolor sit amel adipiscing elit, sed do eiusll tempor
                                            ...
                                            <div class="testi-author">
                                                <div class="testi-info">
                                                        <span class="name"><a
                                                                href="about-us.html">Dorian Cordova</a></span>
                                                </div>
                                            </div>
                                            <div class="testi-quote"><img src="{{ asset('theme/client/assets/img/icons/quote1.webp') }}"
                                                                          width="62" height="44"
        ...
        <div class="shape-group-style3">
            <div class="shape-group-one"><img src="{{ asset('theme/client/assets/img/shape/10.webp') }}" width="274" height="121"
                                              alt="Image-HasTech"></div>
            <div class="shape-group-two"><img src="{{ asset('theme/client/assets/img/shape/11.webp') }}" width="215" height="183"
                                              alt="Image-HasTech"></div>
            <div class="shape-group-three"><img src="{{ asset('theme/client/assets/img/shape/12.webp') }}" width="288" height="166"
                                                alt="Image-HasTech"></div>
            <div class="shape-group-four"><img src="{{ asset('theme/client/assets/img/shape/17.webp') }}" width="493" height="340"
                                               alt="Image-HasTech"></div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4">
                    ...
                    <div class="post-item">
                        <div class="inner-content">
                            <div class="thumb">
                                <a href="blog-details.html"><img src="{{ asset('theme/client/assets/img/blog/1.webp') }}" width="370"
                ...
                <div class="col-md-6 col-lg-4">
                    ...
                    <div class="post-item">
                        <div class="inner-content">
                            <div class="thumb">
                                <a href="blog-details.html"><img src="{{ asset('theme/client/assets/img/blog/2.webp') }}" width="370"
                                                                 height="260" alt="Image-HasTech"></a>
                            </div>
                            <div class="content">
                                <div class="meta-post">
                ...
                <div class="col-md-6 col-lg-4">
                    ...
                    <div class="post-item">
                        <div class="inner-content">
                            <div class="thumb">
                                <a href="blog-details.html"><img src="{{ asset('theme/client/assets/img/blog/3.webp') }}" width="370"
                                                                 height="260" alt="Image-HasTech"></a>
                            </div>
                            <div class="content">
                                <div class="meta-post">
