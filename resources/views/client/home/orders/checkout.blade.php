              ...
              <div class="order-details-table-wrap table-responsive">
                ...
                <table class="table">
                  ...
                  <tbody class="table-body">
                    <tr class="cart-item">
                      <td class="product-name">#name prd<span class="product-quantity">× 1</span></td>
                  ...
                  <div id="PaymentMethodAccordion">
                    ...
                    <div class="card">
                      <div class="card-header" id="check_payments4">
                        <h5 class="title" data-bs-toggle="collapse" data-bs-target="#itemFour" aria-controls="itemTwo" aria-expanded="false">PayPal Express Checkout <img src="{{asset('../theme/client/assets/img/photos/paypal2.webp')}}" width="40" height="26" alt="Image-HasTech"></h5>
                      </div>
