                                        ...
                                        <div class="col-sm-6 col-lg-4">
                                            ...
                                            <div class="product-item">
                                                <div class="inner-content">
                                                    <div class="product-thumb">
                                                        <a href="single-product.html">
                                                            <img src="{{ asset('theme/client/assets/img/shop/2.webp') }}" width="270"
                                                                 height="274" alt="Image-HasTech">
                                                        </a>
                                                        <div class="product-action">
                                                            <a class="btn-product-wishlist"
                                        ...
                                        <div class="col-sm-6 col-lg-4">
                                            ...
                                            <div class="product-item">
                                                <div class="inner-content">
                                                    <div class="product-thumb">
                                                        <a href="single-product.html">
                                                            <img src="{{ asset('theme/client/assets/img/shop/3.webp') }}" width="270"
                                                                 height="274" alt="Image-HasTech">
                                                        </a>
                                                        <div class="product-flag">
                                                            <ul>
                                        ...
                                        <div class="col-sm-6 col-lg-4">
                                            ...
                                            <div class="product-item">
                                                <div class="inner-content">
                                                    <div class="product-thumb">
                                                        <a href="single-product.html">
                                                            <img src="{{ asset('theme/client/assets/img/shop/4.webp') }}" width="270"
                                                                 height="274" alt="Image-HasTech">
                                                        </a>
                                                        <div class="product-action">
                                                            <a class="btn-product-wishlist"
                                        ...
                                        <div class="col-sm-6 col-lg-4">
                                            ...
                                            <div class="product-item">
                                                <div class="inner-content">
                                                    <div class="product-thumb">
                                                        <a href="single-product.html">
                                                            <img src="{{ asset('theme/client/assets/img/shop/5.webp') }}" width="270"
                                                                 height="274" alt="Image-HasTech">
                                                        </a>
                                                        <div class="product-flag">
                                                            <ul>
                                        ...
                                        <div class="col-sm-6 col-lg-4">
                                            ...
                                            <div class="product-item">
                                                <div class="inner-content">
                                                    <div class="product-thumb">
                                                        <a href="single-product.html">
                                                            <img src="{{ asset('theme/client/assets/img/shop/6.webp') }}" width="270"
                                                                 height="274" alt="Image-HasTech">
                                                        </a>
                                                        <div class="product-action">
                                                            <a class="btn-product-wishlist"
                                        ...
                                        <div class="col-sm-6 col-lg-4">
                                            ...
                                            <div class="product-item">
                                                <div class="inner-content">
                                                    <div class="product-thumb">
                                                        <a href="single-product.html">
                                                            <img src="{{ asset('theme/client/assets/img/shop/7.webp') }}" width="270"
                                                                 height="274" alt="Image-HasTech">
                                                        </a>
                                                        <div class="product-flag">
                                                            <ul>
                                                    ...
                                                    <div class="product-info">
                                                        ...
                                                        <h4 class="title"><a href="single-product.html">Simple
                                                                Fabric Shoe</a></h4>
                                                        <div class="prices">
                                                            <span class="price">$240.00</span>
                                                        </div>
                                        ...
                                        <div class="col-sm-6 col-lg-4">
                                            ...
                                            <div class="product-item">
                                                <div class="inner-content">
                                                    <div class="product-thumb">
                                                        <a href="single-product.html">
                                                            <img src="{{ asset('theme/client/assets/img/shop/8.webp') }}" width="270"
                                                                 height="274" alt="Image-HasTech">
                                                        </a>
                                                        <div class="product-action">
                                                            <a class="btn-product-wishlist"
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="product-item product-list-item">
                                                <div class="inner-content">
                                                    <div class="product-thumb">
                                                        <a href="single-product.html">
                                                            <img src="{{ asset('theme/client/assets/img/shop/list-1.webp') }}" width="322"
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="product-item product-list-item">
                                                <div class="inner-content">
                                                    <div class="product-thumb">
                                                        <a href="single-product.html">
                                                            <img src="{{ asset('theme/client/assets/img/shop/list-2.webp') }}" width="322"
                                                                 height="360" alt="Image-HasTech">
                                                        </a>
                                                        <div class="product-action">
                                                            <a class="btn-product-wishlist"
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="product-item product-list-item">
                                                <div class="inner-content">
                                                    <div class="product-thumb">
                                                        <a href="single-product.html">
                                                            <img src="{{ asset('theme/client/assets/img/shop/list-3.webp') }}" width="322"
                                                                 height="360" alt="Image-HasTech">
                                                        </a>
                                                        <div class="product-flag">
                                                            <ul>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="product-item product-list-item">
                                                <div class="inner-content">
                                                    <div class="product-thumb">
                                                        <a href="single-product.html">
                                                            <img src="{{ asset('theme/client/assets/img/shop/list-4.webp') }}" width="322"
                                                                 height="360" alt="Image-HasTech">
                                                        </a>
                                                        <div class="product-action">
                                                            <a class="btn-product-wishlist"
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="product-item product-list-item">
                                                <div class="inner-content">
                                                    <div class="product-thumb">
                                                        <a href="single-product.html">
                                                            <img src="{{ asset('theme/client/assets/img/shop/list-5.webp') }}" width="322"
                                                                 height="360" alt="Image-HasTech">
                                                        </a>
                                                        <div class="product-flag">
                                                            <ul>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="product-item product-list-item">
                                                <div class="inner-content">
                                                    <div class="product-thumb">
                                                        <a href="single-product.html">
                                                            <img src="{{ asset('theme/client/assets/img/shop/list-6.webp') }}" width="322"
                                                                 height="360" alt="Image-HasTech">
                                                        </a>
                                                        <div class="product-action">
                                                            <a class="btn-product-wishlist"
