                                ...
                                <nav>
                                    <div class="myaccount-tab-menu nav nav-tabs" id="nav-tab" role="tablist">
                                        <a href="{{route('account.index')}}">
                                            <button class="nav-link w-100 {{ url()->current() == route('account.index') ? 'active' : '' }}" id="dashboad-tab" data-bs-toggle="tab"
                                                    data-bs-target="#dashboad" type="button" role="tab"
                                                    aria-controls="dashboad" aria-selected="true">Dashboard
                                            </button>
                                        </a>
                                        <a href="{{ route('account.orders') }}">
                                            <button class="nav-link w-100 {{ strpos(url()->current(), 'orders') ? 'active' : '' }}" id="orders-tab" data-bs-toggle="tab"
                                                    data-bs-target="#orders" type="button" role="tab"
                                                    aria-controls="orders" aria-selected="false"> Orders
                                            </button>
                                        </a>
                                        <a href="{{ route('account.addresses') }}">
                                            <button class="nav-link w-100 {{ strpos(url()->current(), 'addresses') ? 'active' : '' }}" id="address-edit-tab" data-bs-toggle="tab"
                                        ...
                                        <a href="{{ route('account.info') }}">
                                            <button class="nav-link w-100 {{ strpos(url()->current(), 'detail') ? 'active' : '' }}" id="account-info-tab" data-bs-toggle="tab"
