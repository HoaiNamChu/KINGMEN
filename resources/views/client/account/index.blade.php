                                ...
                                <div class="tab-content" id="nav-tabContent">
                                    ...
                                    <div class="tab-pane fade show active" id="dashboad" role="tabpanel" aria-labelledby="dashboad-tab">
                                        <div class="myaccount-content">
                                            <h3>Dashboard</h3>
                                            <div class="welcome">
                                                <p>Hello, <strong>{{$userData->username}}</strong> (If Not <strong>{{$userData->username}} !</strong><a href="/logout" class="logout"> Logout</a>)</p>
                                            </div>
                                            ...
                                            @if(Auth::check())
                                                <form action="/update-billing-address" method="POST">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="name" name="name" value="{{ $userData->username }}">
                                                    </div>
                                            ...
                                            <div class="account-details-form">
                                                ...
                                                <form action="#">
                                                    ...
                                                    <div class="single-input-item">
                                                        ...
                                                        <input type="text" id="display-name" value="{{ Auth::user()->username }}" readonly /> <!-- Hiển thị tên hiển thị -->
                                                    </div>
