                                            ...
                                            <div class="swiper-slide">
                                                <a class="lightbox-image" data-fancybox="gallery"
                                                   href="{{ Storage::url($product->image) }}">
                                                    <img src="{{ Storage::url($product->image) }}" width="570"
                                                    ...
                                                    <div class="swiper-slide">
                                                        <a class="lightbox-image" data-fancybox="gallery"
                                                           href="{{ Storage::url($gallery->image) }}">
                                                            <img src="{{ Storage::url($gallery->image) }}" width="570"
                                                                 height="541" alt="Image-HasTech">
                                                        </a>
                                                    </div>
                                                @endforeach
                                    ...
                                    <div class="swiper-container single-product-nav single-product-nav-slider">
                                        <div class="swiper-wrapper">
                                            ...
                                            @if($product->galleries->count())
                                                @foreach($product->galleries as $gallery)
                                                    <div class="swiper-slide">
                                                        <img src="{{ Storage::url($gallery->image) }}" width="127"
                                                             height="127" alt="Image-HasTech">
                                                    </div>
                                                @endforeach
                                            @endif
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="product-item">
                                        <div class="inner-content">
                                            <div class="product-thumb">
                                                <a href="single-product.html">
                                                    <img src="assets/img/shop/7.webp" width="270" height="274"
                                                         alt="Image-HasTech">
                                                </a>
                                                <div class="product-action">
                                                    <a class="btn-product-wishlist" href="shop-wishlist.html"><i
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="product-item">
                                        <div class="inner-content">
                                            <div class="product-thumb">
                                                <a href="single-product.html">
                                                    <img src="assets/img/shop/3.webp" width="270" height="274"
                                                         alt="Image-HasTech">
                                                </a>
                                                <div class="product-flag">
                                                    <ul>
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="product-item">
                                        <div class="inner-content">
                                            <div class="product-thumb">
                                                <a href="single-product.html">
                                                    <img src="assets/img/shop/5.webp" width="270" height="274"
                                                         alt="Image-HasTech">
                                                </a>
                                                <div class="product-action">
                                                    <a class="btn-product-wishlist" href="shop-wishlist.html"><i
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="product-item">
                                        <div class="inner-content">
                                            <div class="product-thumb">
                                                <a href="single-product.html">
                                                    <img src="assets/img/shop/6.webp" width="270" height="274"
                                                         alt="Image-HasTech">
                                                </a>
                                                <div class="product-flag">
                                                    <ul>
