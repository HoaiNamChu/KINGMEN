            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4">
                    ...
                    <div class="post-item">
                        <div class="inner-content">
                            <div class="thumb">
                                <a href="blog-details.html"><img src="{{ asset('theme/client/assets/img/blog/4.webp') }}" width="370"
                                                                 height="260" alt="Image-HasTech"></a>
                            </div>
                            <div class="content">
                                <div class="meta-post">
                ...
                <div class="col-md-6 col-lg-4">
                    ...
                    <div class="post-item">
                        <div class="inner-content">
                            <div class="thumb">
                                <a href="blog-details.html"><img src="{{ asset('theme/client/assets/img/blog/5.webp') }}" width="370"
                                                                 height="260" alt="Image-HasTech"></a>
                            </div>
                            <div class="content">
                                <div class="meta-post">
                ...
                <div class="col-md-6 col-lg-4">
                    ...
                    <div class="post-item">
                        <div class="inner-content">
                            <div class="thumb">
                                <a href="blog-details.html"><img src="{{ asset('theme/client/assets/img/blog/6.webp') }}" width="370"
                                                                 height="260" alt="Image-HasTech"></a>
                            </div>
                            <div class="content">
                                <div class="meta-post">
                                ...
                                <h4 class="title"><a href="blog-details.html">Marc Jacobs Spring 2020 Runway</a>
                                </h4>
                                <a class="post-btn" href="blog.html">Read More</a>
                            </div>
                        </div>
