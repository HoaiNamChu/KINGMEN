                ...
                <div class="offcanvas-xxl offcanvas-start h-100" tabindex="-1" id="Contactoffcanvas"
                    ...
                    <div class="card position-relative overflow-hidden">
                        <div class="card-header border-0 d-flex justify-content-between align-items-center">
                            ...
                            <a href="#user-setting" class="fs-18" type="button" data-bs-toggle="offcanvas"
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide avatar-sm">
                                    <div class="chat-user-status-box">
                                            <span><img src="{{ asset('theme/admin/assets/images/users/avatar-1.jpg') }}"
                                                       alt="avatar-1"
                                                       class="img-fluid avatar-sm rounded-circle avatar-border"/></span>
                                    </div>
                                </div>
                                <div class="swiper-slide avatar-sm">
                                    <div class="chat-user-status-box">
                                            <span><img src="{{ asset('theme/admin/assets/images/users/avatar-2.jpg') }}"
                                                       alt="avatar-2"
                                                       class="img-fluid avatar-sm rounded-circle avatar-border"/></span>
                                    </div>
                                </div>
                                <div class="swiper-slide avatar-sm">
                                    <div class="chat-user-status-box">
                                            <span><img src="{{ asset('theme/admin/assets/images/users/avatar-3.jpg') }}"
                                                       alt="avatar-3"
                                                       class="img-fluid avatar-sm rounded-circle avatar-border"/></span>
                                    </div>
                                </div>
                                <div class="swiper-slide avatar-sm">
                                    <div class="chat-user-status-box">
                                            <span><img src="{{ asset('theme/admin/assets/images/users/avatar-4.jpg') }}"
                                                       alt="avatar-4"
                                                       class="img-fluid avatar-sm rounded-circle avatar-border"/></span>
                                    </div>
                                </div>
                                <div class="swiper-slide avatar-sm">
                                    <div class="chat-user-status-box">
                                            <span><img src="{{ asset('theme/admin/assets/images/users/avatar-5.jpg') }}"
                                                       alt="avatar-5"
                                                       class="img-fluid avatar-sm rounded-circle avatar-border"/></span>
                                    </div>
                                </div>
                                <div class="swiper-slide avatar-sm">
                                    <div class="chat-user-status-box">
                                            <span><img src="{{ asset('theme/admin/assets/images/users/avatar-6.jpg') }}"
                                                       alt="avatar-6"
                                                       class="img-fluid avatar-sm rounded-circle avatar-border"/></span>
                                    </div>
                                </div>
                                <div class="swiper-slide avatar-sm">
                                    <div class="chat-user-status-box">
                                            <span><img src="{{ asset('theme/admin/assets/images/users/avatar-7.jpg') }}"
                                                       alt="avatar-7"
                                                       class="img-fluid avatar-sm rounded-circle avatar-border"/></span>
                                    </div>
                                </div>
                                <div class="swiper-slide avatar-sm">
                                    <div class="chat-user-status-box">
                                            <span><img src="{{ asset('theme/admin/assets/images/users/avatar-8.jpg') }}"
                                                       alt="avatar-8"
                                                       class="img-fluid avatar-sm rounded-circle avatar-border"/></span>
                                    </div>
                                </div>
                                <div class="swiper-slide avatar-sm">
                                    <div class="chat-user-status-box">
                                            <span><img src="{{ asset('theme/admin/assets/images/users/avatar-9.jpg') }}"
                                                       alt="avatar-9"
                                                       class="img-fluid avatar-sm rounded-circle avatar-border"/></span>
                                    </div>
                                </div>
                                <div class="swiper-slide avatar-sm">
                                    <div class="chat-user-status-box">
                                            <span><img
                                                    src="{{ asset('theme/admin/assets/images/users/avatar-10.jpg') }}"
                                                    alt="avatar-10"
                                                    class="img-fluid avatar-sm rounded-circle avatar-border"/></span>
                                    </div>
                                </div>
...
{{--                                                        <i class="bx bx-check-double text-success"></i>--}}
                        ...
                        <div class="offcanvas offcanvas-start position-absolute shadow w-100" data-bs-scroll="true"
                             data-bs-backdrop="false" tabindex="-1" id="user-setting"
                            ...
                            <div class="offcanvas-body p-0 h-100" data-simplebar>
                                ...
                                <div class="d-flex align-items-center px-3 pb-3 border-bottom">
                                    <img src="{{ asset('theme/admin/assets/images/users/avatar-1.jpg') }}"
                                         ...
                                         height="36" alt="avatar-1"/>
                                    <div class="flex-grow-1">
                                        <div class="float-end">
                                            <a href="javascript:void(0);"><i class="bx bx-qr-scan fs-20"></i></a>
                                        </div>
                                        <h5 class="my-0 fs-14">Gaston Lapierre</h5>
                                        <p class="mt-1 mb-0 text-muted"><span class="w-75">Hey there! I am using Larkon Chat.</span>
                                        </p>
                                    </div>
                                </div>
                                                        ...
                                                        aria-expanded="false" aria-controls="collapseAccount">
                                                                           <span class="d-flex align-items-center">
                                                                                ...
                                                                                <span class="flex-grow-1">
                                                                                     <span
                                                                                         class="fs-14 h5 mt-0 mb-1 d-block">Account</span>
                                                                                     <span
                                                                                         class="mt-1 mb-0 text-muted w-75">Privacy, security, change number</span>
                                                                                </span>
                                                                           </span>
                                            ...
                                            <div id="collapseAccount" class="accordion-collapse collapse"
                                                ...
                                                <div class="accordion-body pb-0">
                                                    <ul class="list-unstyled mb-0">
                                                        <li class="mb-2"><a href="javascript:void(0);"><i
                                                                    class="bx bx-lock-alt fs-18 me-2"></i>Privacy</a>
                                                        </li>
                                                        <li class="mb-2"><a href="javascript:void(0);"><i
                                                                    class="bx bx-check-Larkon fs-18 me-2"></i>Security</a>
                                                        </li>
                                                        <li class="mb-2"><a href="javascript:void(0);"><i
                                                                    class="bx bx-badge-check fs-18 me-2"></i>Two-step
                                                                verification</a></li>
                                                        <li class="mb-2"><a href="javascript:void(0);"><i
                                                                    class="bx bx-arrow-from-left fs-18 me-2"></i>Change
                                                                number</a></li>
                                                        <li class="mb-2"><a href="javascript:void(0);"><i
                                                                    class="bx bx-info-circle fs-18 me-2"></i>Request
                                                                account
                                                                info</a></li>
                                                        <li><a href="javascript:void(0);"><i
                                                                    class="bx bx-trash fs-18 me-2"></i>Delete my
                                                                account</a>
                                                        </li>
                                                    </ul>
                                        ...
                                        <div class="accordion-item border-0">
                                            <h5 class="accordion-header my-0" id="headingChats">
                                                <button class="accordion-button px-0 collapsed" type="button"
                                                        data-bs-toggle="collapse" data-bs-target="#collapseChats"
                                                        aria-expanded="false" aria-controls="collapseChats">
                                                                           <span class="d-flex align-items-center">
                                                                                <i class="bx bx-message-dots me-3 fs-20"></i>
                                                                                <span class="flex-grow-1">
                                                                                     <span
                                                                                         class="fs-14 h5 mt-0 mb-1 d-block">Chats</span>
                                                                                     <span
                                                                                         class="mt-1 mb-0 text-muted w-75">Theme, wallpapers, chat history</span>
                                                                                </span>
                                                                           </span>
                                                </button> <!-- end accordion button -->
                                            </h5> <!-- end accordion header -->
                                            <div id="collapseChats" class="accordion-collapse collapse"
                                                 aria-labelledby="headingChats" data-bs-parent="#accordionSetting">
                                                <div class="accordion-body pb-0">
                                                    ...
                                                    <ul class="list-unstyled mb-0">
                                                        ...
                                                        <li class="mb-2"><a href="javascript:void(0);"><i
                                                                    class="bx bx-image fs-16 me-2"></i>Wallpaper</a>
                                                        </li>
                                                    </ul>
                                                    <hr>
                                                    <h5>Chat Setting</h5>
                                                    <ul class="list-unstyled">
                                                        <li class="mb-2 ms-2">
                                                            ...
                                                            <p class="mb-0 text-muted fs-12">Show Newly downloaded
                                                                media in your phone's gallery</p>
                                                        </li>
                                                        <li class="mb-2 ms-2">
                                                            <div class="float-end">
                                                                <div class="form-check form-switch">
                                                            ...
                                                            <p class="mb-0 text-muted fs-12">Enter key will send
                                                                your message</p>
                                                        </li>
                                                        <li class="mb-2 ms-2">
                                                    ...
                                                    <ul class="list-unstyled mb-0">
                                                        ...
                                                        <li class="mb-2"><a href="javascript:void(0);"><i
                                                                    class="bx bx-cloud-upload fs-16 me-2"></i>Chat
                                                                Backup</a></li>
                                                        <li><a href="javascript:void(0);"><i
                                                                    class="bx bx-history fs-16 me-2"></i>Chat
                                                                History</a>
                                                        </li>
                                                    </ul>
                                                </div> <!-- end accordion body -->
                                        ...
                                        <div class="accordion-item border-0">
                                            <h5 class="accordion-header my-0" id="headingNotification">
                                                <button class="accordion-button px-0 collapsed" type="button"
                                                        ...
                                                        data-bs-target="#collapseNotification" aria-expanded="false"
                                                        aria-controls="collapseNotification">
                                                                           <span class="d-flex align-items-center">
                                                                                <i class="bx bx-bell me-3 fs-20"></i>
                                                                                <span class="flex-grow-1">
                                                                                     <span
                                                                                         class="fs-14 h5 mt-0 mb-1 d-block">Notification</span>
                                                                                     <span
                                                                                         class="mt-1 mb-0 text-muted w-75">Message, group, call tones</span>
                                                                                </span>
                                                                           </span>
                                                </button> <!-- end accordion button -->
                                            </h5> <!-- end accordion header -->
                                            <div id="collapseNotification" class="accordion-collapse collapse"
                                                ...
                                                <div class="accordion-body pb-0">
                                                    <ul class="list-unstyled mb-0">
                                                        <li class="mb-2">
                                                            ...
                                                            <p class="mb-0 text-muted fs-12">Play sound for incoming
                                        ...
                                        <div class="accordion-item border-0">
                                                ...
                                                <button class="accordion-button px-0 collapsed" type="button"
                                                        ...
                                                        aria-expanded="false" aria-controls="collapseStorage">
                                                                           <span class="d-flex align-items-center">
                                                                                ...
                                                                                <span class="flex-grow-1">
                                                                                     <span
                                                                                         class="fs-14 h5 mt-0 mb-1 d-block">Storage and data</span>
                                                                                     <span
                                                                                         class="mt-1 mb-0 text-muted w-75">Network usage, auto download</span>
                                                                                </span>
                                                                           </span>
                                                </button> <!-- end accordion button -->
                                            </h5> <!-- end accordion header -->
                                            <div id="collapseStorage" class="accordion-collapse collapse"
                                                ...
                                                <div class="accordion-body pb-0">
                                                    ...
                                                    <ul class="list-unstyled mb-0">
                                                        <li class="d-flex">
                                                            ...
                                                            <div class="flex-grow-1">
                                                                ...
                                                                <p class="mb-0 text-muted fs-12">7.2 GB sent - 13.8
                                                                    GB received</p>
                                                            </div>
                                                        </li>
                                                    </ul>
                                                    ...
                                                    <p class="mb-0 text-muted fs-12">Voice message are always
                                                    ...
                                                    <ul class="list-unstyled mb-0 mt-2">
                                                        ...
                                                        <li class="mb-2 ms-2">
                                                            <a href="javascript:void(0);">When connected on
                                                                wi-fi</a>
                                                            <p class="mb-0 text-muted fs-12">No media</p>
                                                        </li>
                                                        <li class="mb-2 ms-2">
                                                    ...
                                                    <p class="mb-0 text-muted fs-12">Choose the quality of media
                                                        files to be sent</p>
                                                    <ul class="list-unstyled mb-0 mt-2">
                                                        <li class="ms-2">
                                                ...
                                                <button class="accordion-button px-0 collapsed" type="button"
                                                        ...
                                                        aria-expanded="false" aria-controls="collapseHelp">
                                                                           <span class="d-flex align-items-center">
                                                                                ...
                                                                                <span class="flex-grow-1">
                                                                                     <span
                                                                                         class="fs-14 h5 mt-0 mb-1 d-block">Help</span>
                                                                                     <span
                                                                                         class="mt-1 mb-0 text-muted w-75">Help center, contact us, privacy policy</span>
                                                                                </span>
                                                                           </span>
                                                </button> <!-- end accordion button -->
                                            </h5> <!-- end accordion header -->
                                            <div id="collapseHelp" class="accordion-collapse collapse"
                                                 aria-labelledby="headingHelp" data-bs-parent="#accordionSetting">
                                                <div class="accordion-body pb-0">
                                                    <ul class="list-unstyled mb-0">
                                                        <li class="mb-2"><a href="javascript:void(0);"><i
                                                                    class="bx bx-info-circle fs-16 me-2"></i>Help
                                                                center</a>
                                                        </li>
                                                        <li class="mb-2 d-flex">
                                                        ...
                                                        <li class="mb-2"><a href="javascript:void(0);"><i
                                                                    class="bx bx-book-content fs-16 me-2"></i>Teams
                                                                and
                                                                Privacy Policy</a></li>
                                                        <li><a href="javascript:void(0);"><i
                                                                    class="bx bx-info-circle fs-16 me-2"></i>App
                                                                info</a>
                                                        </li>
                                                    </ul>
                                                </div> <!-- end accordion body -->
            ...
            <div class="col-xxl-9">
                <div class="card position-relative overflow-hidden">
                                ...
                                <li class="list-inline-item fs-20 dropdown d-none d-md-flex">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        <a class="dropdown-item" href="javascript: void(0);"><i
                                                class="bx bx-user-circle me-2"></i>View Profile</a>
                                        <a class="dropdown-item" href="javascript: void(0);"><i
                                                class="bx bx-music me-2"></i>Media, Links and Docs</a>
                                        <a class="dropdown-item" href="javascript: void(0);"><i
                    ...
                    <!-- Profile Start -->
                    <div class="offcanvas offcanvas-end position-absolute shadow border-start" data-bs-scroll="true"
                        ...
                        <div class="offcanvas-body p-0 h-100" data-simplebar>
                            <div class="p-3">
                                <div class="text-center">
                                    <img src="{{ asset('theme/admin/assets/images/users/avatar-4.jpg') }}" alt="shreyu"
                                         class="img-thumbnail avatar-lg rounded-circle mb-1">
                                    <h4>Gilbert Chicoine</h4>
                                    <button class="btn btn-primary btn-sm mt-1"><i class="bi bi-envelope me-1"></i>Send
                                        Email
                                    </button>
                                    <p class="text-muted mt-2 fs-14">Last Interacted: <strong class="text-success">Online</strong>
                                    </p>
                                </div>
                                ...
                                <div class="mt-3">
                                    ...
                                    <p class="mt-3 mb-1"><strong><i class="bi bi-phone"></i> Phone Number:</strong>
                                    </p>
                                    <p>+1 456 9595 9594</p>

                                    <p class="mt-3 mb-1"><strong><i class="bi bi-geo-alt"></i> Location:</strong>
                                    </p>
                                    <p>California, USA</p>
                                ...
                                <div class="row gx-1 pt-2">
                                    <div class="col-4">
                                        <a href="javascript:void(0);">
                                            <img src="{{ asset('theme/admin/assets/images/small/img-1.jpg') }}"
                                                 alt="img-1"
                                    ...
                                    <div class="col-4">
                                        <a href="javascript:void(0);">
                                            <img src="{{ asset('theme/admin/assets/images/small/img-2.jpg') }}"
                                                 alt="img-2"
                                                 class="img-fluid rounded">
                                        </a>
                                    </div>
                                    <div class="col-4">
                                        <div class="position-relative overflow-hidden rounded">
                                            <a href="javascript:void(0);">
                                                <img src="{{ asset('theme/admin/assets/images/small/img-3.jpg') }}"
                                                     alt="img-3"
                                                     class="img-fluid rounded">
...
@section('script')
    <script>
        let route = '{{ route('admin.chats.update', $chatRoom->id) }}';
