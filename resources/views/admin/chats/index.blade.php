                        ...
                        <div class="offcanvas offcanvas-start position-absolute shadow w-100" data-bs-scroll="true"
                            ...
                            <div class="offcanvas-body p-0 h-100" data-simplebar>
                                ...
                                <div class="d-flex align-items-center px-3 pb-3 border-bottom">
                                    <img src="{{ asset('theme/admin/assets/images/users/avatar-1.jpg') }}" class="me-2 rounded-circle"
                                                ...
                                                <div class="accordion-body pb-0">
                                                    <ul class="list-unstyled mb-0">
                                                        <li class="mb-2"><a href="javascript:void(0);"><i
                                                                    class="bx bx-lock-alt fs-18 me-2"></i>Privacy</a></li>
                                                        <li class="mb-2"><a href="javascript:void(0);"><i
                                                        ...
                                                        <li class="mb-2"><a href="javascript:void(0);"><i
                                                                ...
                                                                number</a></li>
                                                        <li class="mb-2"><a href="javascript:void(0);"><i
                                                                    class="bx bx-info-circle fs-18 me-2"></i>Request account
                                                                info</a></li>
                                                        <li><a href="javascript:void(0);"><i
                                                                    class="bx bx-trash fs-18 me-2"></i>Delete my account</a>
                                                        </li>
                                                    </ul>
                                            ...
                                            <div id="collapseChats" class="accordion-collapse collapse"
                                                ...
                                                <div class="accordion-body pb-0">
                                                    ...
                                                    <ul class="list-unstyled mb-0">
                                                        ...
                                                        <li class="mb-2"><a href="javascript:void(0);"><i
                                                                    class="bx bx-image fs-16 me-2"></i>Wallpaper</a></li>
                                                    </ul>
                                                    <hr>
                                                    <h5>Chat Setting</h5>
                                                    ...
                                                    <ul class="list-unstyled mb-0">
                                                        ...
                                                        <li class="mb-2"><a href="javascript:void(0);"><i
                                                                ...
                                                                Backup</a></li>
                                                        <li><a href="javascript:void(0);"><i
                                                                    class="bx bx-history fs-16 me-2"></i>Chat History</a>
                                                        </li>
                                                    </ul>
                                                </div> <!-- end accordion body -->
                                            </div> <!-- end accordion collapse -->
                                        ...
                                        <div class="accordion-item border-0">
                                            ...
                                            <div id="collapseHelp" class="accordion-collapse collapse"
                                                ...
                                                <div class="accordion-body pb-0">
                                                    <ul class="list-unstyled mb-0">
                                                        <li class="mb-2"><a href="javascript:void(0);"><i
                                                                    class="bx bx-info-circle fs-16 me-2"></i>Help center</a>
                                                        </li>
                                                        <li class="mb-2 d-flex">
                                                        ...
                                                        <li class="mb-2"><a href="javascript:void(0);"><i
                                                                    class="bx bx-book-content fs-16 me-2"></i>Teams and
                                                                Privacy Policy</a></li>
                                                        <li><a href="javascript:void(0);"><i
                                                                    class="bx bx-info-circle fs-16 me-2"></i>App info</a>
                                                        </li>
                                                    </ul>
                                                </div> <!-- end accordion body -->
                                            </div> <!-- end accordion collapse -->
                ...
                <div class="card position-relative overflow-hidden">
                    ...
                    <div class="card-header d-flex align-items-center mh-100">
                        ...
                        <div class="d-flex align-items-center">
                            <img src="{{ asset('theme/admin/assets/images/users/avatar-4.jpg') }}" class="me-2 rounded" height="36"
                                 alt="avatar-4"/>
                            ...
                            <div class="modal-content video-call">
                                ...
                                <div class="modal-header border-0 mb-5 justify-content-end">
                                    <div class="video-call-head">
                                        <img src="{{ asset('theme/admin/assets/images/users/avatar-4.jpg') }}" class="rounded" alt="avatar-4"/>
                                    </div>
                                </div>
                            ...
                            <div class="modal-content voice-call">
                                ...
                                <div class="modal-header border-0 mt-5 justify-content-center">
                                    <div class="voice-call-head">
                                        <img src="{{ asset('theme/admin/assets/images/users/avatar-4.jpg') }}" class="rounded-circle"
                                             alt="avatar-4"/>
                                    </div>
                                </div>
                        ...
                        <div class="offcanvas-body p-0 h-100" data-simplebar>
                            <div class="p-3">
                                ...
                                <div class="row gx-1 pt-2">
                                    <div class="col-4">
                                        <a href="javascript:void(0);">
                                            <img src="{{ asset('theme/admin/assets/images/small/img-1.jpg') }}" alt="img-1"
                                                 class="img-fluid rounded">
                                        </a>
                                    </div>
                                    <div class="col-4">
                                        <a href="javascript:void(0);">
                                            <img src="{{ asset('theme/admin/assets/images/small/img-2.jpg') }}" alt="img-2"
                                                 class="img-fluid rounded">
                                        </a>
                                    </div>
                                    <div class="col-4">
                                        <div class="position-relative overflow-hidden rounded">
                                            <a href="javascript:void(0);">
                                                <img src="{{ asset('theme/admin/assets/images/small/img-3.jpg') }}" alt="img-3"
                                                     class="img-fluid rounded">
